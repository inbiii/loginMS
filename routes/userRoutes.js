...
router.post("/makeAnAccount", redirLogin, makeAnAccount);

router.get("/registration/:token", redirHome, emailConfirm);

router.post("/register", register);

router.post("/login", redirHome, login);

router.post("/resetPassword", redirHome, resetPass);

router.post("/resetPassword/:token", redirHome, resetConfirm);
